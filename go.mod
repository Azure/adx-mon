...
require (
	buf.build/gen/go/opentelemetry/opentelemetry/bufbuild/connect-go v1.10.0-20240209200904-3b1a4532819a.1
	buf.build/gen/go/opentelemetry/opentelemetry/protocolbuffers/go v1.34.1-20240514201103-f81222fd2e5e.1
