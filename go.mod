...
require (
	buf.build/gen/go/opentelemetry/opentelemetry/bufbuild/connect-go v1.10.0-20240606200852-c7d908a3f6e4.1
	buf.build/gen/go/opentelemetry/opentelemetry/protocolbuffers/go v1.34.2-20240617172851-f986b2457766.1
...
replace (
	...
	github.com/tenebris-tech/tail => github.com/mkeesey/tail v1.1.1-0.20240418231158-5aff28438c9d
